...
<div class="container">
    <div class="row form-container">
        <div class="col-md-2 register-left">
            ...
            <h1>Welcome</h1>
            <h4>Please register <br> or click login if <br> you have an <br> existing account</h4>
...
<%--                        <form action="/register" method="post">--%>
<%--                            <input class="mt-5" type="text" name="username"><br>--%>
<%--                            <input class="mt-2" type="text" name="email"><br>--%>
<%--                            <input class="mt-2" type="password" name="password"><br>--%>
<%--                            <input class="mt-2" type="password" name="confirm_password"><br>--%>
<%--                            <input class="mt-2" type="submit">--%>
<%--                        </form>--%>
                        <div class="col-md-6">
                            <div class="ferf">
                                <input name="username" type="text" class="form-control" placeholder="Create User Name *">
                            </div>
