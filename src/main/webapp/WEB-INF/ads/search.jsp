...
<div class="resultsContainer" id="apply">
    <c:forEach var="ad" items="${ads}">
        <div>
            ...
            <h6>${ad.condition}</h6>
            <p>${ad.description}</p>
            <a href="/profile">${sessionScope.user.username}</a>
        </div>
    </c:forEach>
</div>

<%--<div class="card-container container grid-body" id="cardBody" style='width: max-content'>--%>
<%--    <div class="card card-flip card-body select">--%>
<%--        <div class="front card-block">--%>
<%--            <h5 class='select card-title' style="text-align: center; color: white; font-size: larger; font-weight: bold">${ad.title}</h5>--%>
<%--            <img class="select" src=${ad.image_url} alt="thecount" style="width: 250px; height: 350px;"></div>--%>
<%--        <div class="back card-block" style="width: 250px; height: 350px;">--%>
<%--            <h5 class="card-title">${ad.price}</h5>--%>
<%--            <h6 class="card-subtitle text-muted select">${ad.conditions}</h6>--%>
<%--            <p class="card-text desc select">${ad.description}</p>--%>
<%--            <a href="/profile" class="btn btn-primary btn-l">${sessionScope.user.username}</a>--%>
<%--        </div>--%>
<%--    </div>--%>
<%--</div>--%>
