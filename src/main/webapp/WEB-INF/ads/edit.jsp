            ...
            <div class="col-6 bannerTextBlock">
                <div class="row">
                    <div style="margin-right: auto; margin-left: auto">
                        <h3>Select an Ad:</h3>
                        <div class="col">
                            <select name="editMenu" id="genres" class="selectpicker dropdown" aria-label="Genre"
                    ...
                    <div style="margin-right: auto; margin-left: auto">
                        <h3>Edit your book's Tile:</h3>
                        <input name="title" type="text" id="search" placeholder="Book Title"
                               style="border: 6px inset #7A7072 ; border-radius: 0 20%; font-weight: bolder; font-size: 15px;">
                    </div>
                </div>
                <div style="margin-top: 10px">
                    <h3>Select a new Genre:</h3>
                    <div class="col">
                ...
                <div style="margin-top: 10px">
                    <h3>Approximate your book's condition:</h3>
                    <div class="col">
                        <select name="condition" id="condition" class="selectpicker dropdown" aria-label="condition"
                                data-style="btn-primary">
                            <option selected>What genre is it?</option>
                ...
                <div style="margin: 10px 0 0 10px">
                    <h3 >Tell us about your reading experience with this book:</h3>
                    <textarea name="description" class="form-control form-field" style="margin-right: auto; margin-left: auto" id="description" rows="3"
                              placeholder="Tell us about the book you are selling" style="height: auto"></textarea>
                </div>
                <div style="margin: 10px 0 0 10px">
                    <h3>Edit your book's price: </h3>
